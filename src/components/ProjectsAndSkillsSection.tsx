  ...
  const projects = [
    {
      ...
      tools: ["Python", "OpenCV", "YOLO11", "PyTorch", "Image Preprocessing", "Dataset Annotation"],
    },
    {
      ...
      tools: ["Python", "OpenCV", "SuperPoint", "SuperGlue", "Multi-Drone Vision", "Feature Matching"],
    },
    {
      ...
      tools: ["Python", "DSPy", "LLMs", "Prompt Engineering", "ALFWorld", "Zero-shot Reasoning"],
    },
    {
      ...
      tools: ["Python", "OpenCV", "Fourier Transform", "Contour Analysis", "Statistical Modeling"],
    },
    {
      ...
      tools: ["C++", "OpenCV", "Edge Detection", "Hough Transform", "Real-Time Systems"],
    },
    {
      ...
      tools: ["JavaScript", "Chrome APIs", "React", "Web Scraping", "User Profiling"],
    },
    {
      title: "Stock Price Predictor",
      description:
        "Trained an ML model to forecast stock movements using time-series analysis and technical indicators. Combined historical price data with engineered features to simulate predictive trading strategies.",
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="space-y-12">
          {projects.map((proj, idx) => (
            <div key={idx} className="bg-background/80 rounded-lg border border-border p-6 shadow-md">
              <h3 className="text-2xl font-semibold mb-2 text-primary">{proj.title}</h3>

      ...
      <div className="container max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto opacity-0 animate-fade-in-delay-4">
            I'm a CS + Math student at McGill University, currently interning at
            ARA Robotics. Passionate about computer vision, autonomous systems,
            and solving real-world problems through code and systems design.
          </p>
